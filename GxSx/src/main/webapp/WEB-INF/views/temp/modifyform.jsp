	            ...
	            <div class="row">
	                <div class="col-lg-12 text-center">
	                    <div class="breadcrumb__text">
	                        <h21 style="font-size: 34px;color:white; font-weight:900">CONTACT</h21>	               
	                    </div>
	                </div>
	            </div>
	        </div>
			...
			<div id="fh5co-contact">
				<div class="row animate-box fadeInUp animated-fast">
					<div class="col-md-6 col-md-offset-3 text-center fh5co-heading">
						...
						<p>If you want to modify the data, Enter your password to identify.</p>
						</br></br>
					<form action="modify.do" method="post">						
						<input style="width:300px;font-size:18px;margin-left:85px" type="text" class="form-control" placeholder="Password">
						</br>		
						<input type="submit" value="Send" class="btn btn-primary btn-modify">							
					</form>
