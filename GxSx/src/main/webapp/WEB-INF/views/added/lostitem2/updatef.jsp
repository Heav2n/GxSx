...
<input type="hidden" name="lono" value="${updatef.lono}">
<table border='0' width='600' align='center' cellpadding='3' cellspacing='1' bordercolor='gray'>	
<tr>
   <td width='20%' align='center' >작성자</td>
   <td>
      <input name='louid' readonly value='${updatef.louid}'/>
   </td>
</tr>
...
<tr>
	...
	<td><input name='losub' value='${updatef.losub}'/></td>
</tr>
			
<tr>
	<td align='center'>내용</td>
	<td><textarea id='ta' name='locon' rows='15' cols='70'>${updatef.locon}</textarea></td>
</tr>
<tr>
   ...
   <tr>
	<td align='center'>위치</td>
      <td><input name='loplace' value='${updatef.loplace}' /></td>
   </tr>
	<tr>
      <td align='center'>사진</td>
      <td>
         <input type="text" name="lopicname" value='${updatef.lopicname}'/>
      </td>
   </tr>
<tr>
