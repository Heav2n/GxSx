...
<TR size='2' align='center' noshade bgcolor='AliceBlue'>
	...
	<th color='gray'>cname</th>
	<th color='gray'>picture</th>
...
<c:forEach items="${listResult.list}" var="finditem">
	<TR align='center' noshade>
		<TD>${finditem.fino}</TD>
		<TD>${finditem.fiuid}</TD>
		<TD>${finditem.ficname}</TD>
		<TD><img src="../resources/Findimgs/${finditem.fipicname}" height=100 width=75></TD>
	    <TD>
	      <a href="content.do?fino=${finditem.fino}">
		    ${finditem.fisub}
		  </a>
		</TD>
		<TD>${finditem.fidate}</TD>
	   </TR> 
</c:forEach>      
