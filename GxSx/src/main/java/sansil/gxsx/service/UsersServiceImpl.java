...
public class UsersServiceImpl implements UsersService {
	...
	private UsersMapper usersMapper; //Spring 4.3~ : 자동 Injection
	...
	public UsersListResult getUsersResult(long page, long pageSize) {
		...
		//UsersVo usersVo = new UsersVo(page, pageSize);
		//List<Users> list = usersMapper.selectPerPage(usersVo);
	...
	public List<FindListVo> getFindList(String fiuId, HttpServletRequest request, HttpSession session) {
		...
		log.info("#> controller findList : "+findList);
		for(FindListVo fist : findList) {
			log.info("#> query "+ query.getPaging());
			/*
